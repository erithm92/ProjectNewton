...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'TempBuild.data';
    var REMOTE_PACKAGE_BASE = 'TempBuild.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6253620;
      var PACKAGE_UUID = 'ef447e90-d1d7-4155-b3c0-e43cf14a9402';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 3380142, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(3380142, 3380557, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(3380557, 3386667, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(3386667, 5351023, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(5351023, 6225995, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6225995, 6253620, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_TempBuild.data');

    };
    Module['addRunDependency']('datafile_TempBuild.data');
